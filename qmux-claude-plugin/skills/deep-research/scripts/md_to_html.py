...
def convert_markdown_to_html(markdown_text: str) -> Tuple[str, str]:
    ...
    # injection; the transforms below inject only their own trusted tags, whose
    # angle brackets are added after this point and so survive intact.
    # (Note: this also escapes any intentional HTML entities the author wrote,
    #  e.g. "&rarr;" renders literally — write the Unicode character instead.)
